...
public class MovieHistoryFileServiceTest {
    ...
    public void testLoadFromFile() {
        ...
        assertThat(result.getMovies().size()).isEqualTo(28796);
        ...
        assertThat(result.getMovies().get(28795).getTitle()).isEqualTo("Destroyer");
        assertThat(result.getMovies().get(28795).getYear()).isEqualTo(2018);
        assertThat(result.getMovies().get(28795).getCast()).isNotEmpty();
        assertThat(result.getMovies().get(28795).getCast()).contains("Nicole Kidman", "Tatiana Maslany", "Sebastian Stan", "Toby Kebbell", "Scoot McNairy");
        assertThat(result.getMovies().get(28795).getGenres()).isNotEmpty();
        assertThat(result.getMovies().get(28795).getGenres()).contains("Crime", "Thriller");
    }
